...
#try to convert agent to Twin Delayed DDPG (T3D)
#reference:
...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed=2, fc1_units=400, fc2_units=300,
                replay_buffer_size=int(1e5), minibatch_size=128, gamma=0.99, tau=1e-3, 
                 actor_learning_rate=1e-4, critic_learning_rate=1e-3, l2_weight_decay=0,
                mu_noise=0., theta_noise=0.15, sigma_noise=0.2):
        ...
        print(f"Agent parameters: state_size={state_size} action_size={action_size} random_seed={random_seed}\n \
              fc1_units={fc1_units} fc2_units={fc2_units}\n \
              replay_buffer_size={replay_buffer_size} minibatch_size={minibatch_size} gamma={gamma}\n \
              tau={tau} actor_learning_rate={actor_learning_rate} critic_learning_rate={critic_learning_rate}\n \
              l2_weight_decay={l2_weight_decay}\n \
              mu_noise={mu_noise} theta_noise={theta_noise} sigma_noise={sigma_noise}")
        ...
        # Noise process
        self.noise = OUNoise(action_size, random_seed, mu_noise, theta_noise, sigma_noise)
